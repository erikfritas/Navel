...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                    <span class="ml-2 text-sm text-gray-600"><?php echo e(__('Se lembre de mim')); ?></span>
                </label>
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                <div class="p-2">
                    <a class="underline text-sm text-blue-600 hover:text-blue-900" href="<?php echo e(route('register')); ?>">
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH /var/www/html/sites/laravel/aulas/Teste2/resources/views/auth/login.blade.php ENDPATH**/ ?>